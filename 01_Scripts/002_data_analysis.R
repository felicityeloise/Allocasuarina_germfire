...
par(mfrow = c(1,2), mar = c(5,6.5,2.5,2))
...
mtext(side = 1, expression(bold("Seed weight (mg)")), line = 4, cex = 2.5)
mtext(side = 2, expression(bold("Proportion germination")), line = 4, cex = 2.5)
...
mtext(side = 1, expression(bold("Temperature seasonality")), line = 4, cex = 2.5)
mtext(side = 2, expression(bold("Seed weight (mg)")), cex = 2.5, line = 3)
...
mtext(side = 2, expression(bold("Seed weight (mg)")), cex = 2.5, line = 3)
mtext(side = 1, expression(bold("Latitude")), cex = 2.5, line = 4)
